...
# PATENT 카테고리 신설 — LICENSE 는 alias 로 강등됨 (live_chatbot_test_20260504 회귀)
PATENT_GOLDEN_CASES = [
    ("특허 신청 어떻게 하나요",                                     "PATENT"),
    ("특허 신청 비용이 드나요",                                     "PATENT"),
    ("지정 기간이 얼마나 되나요",                                   "PATENT"),
    ("특허 취소 사유는 무엇인가요",                                 "PATENT"),
    ("보세전시장 특허기간은 어떻게 되나요",                         "PATENT"),
    ("특허 갱신 가능한가요",                                        "PATENT"),
    ("등록 신청 어떻게",                                            "PATENT"),
    ("보세전시장 설치·운영 특허를 받으려면 어디를 봐야 하나요",     "PATENT"),
    ("특허 연장이 가능한가요",                                      "PATENT"),
    ("특허 신청 시 어떤 서류가 필요한가요",                         "PATENT"),
